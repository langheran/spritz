class CWebView extends CWebViewer
{
	...
	Exec(script) ;// For HTML5
	{
		wb := this.__Ptr
		wb.document.parentwindow.execScript(script)
	}
	...
	Busy
	{
		get {
			wb := this.__Ptr
			return (wb.ReadyState != 4) || (wb.Document.readyState != "complete") || wb.Busy
		}
	}
